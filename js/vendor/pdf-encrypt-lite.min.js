/* @pdfsmaller/pdf-encrypt-lite@1.0.1 (self-hosted, patched to use global PDFLib) */
var __0$=window.PDFLib;var require=n=>{const e=m=>typeof m.default<"u"?m.default:m,c=m=>Object.assign({__esModule:true},m);switch(n){case"pdf-lib":return c(__0$);default:console.error('module "'+n+'" not found');return null;}};
